...
<div class="-ml-4 md:-ml-16 2xl:-ml-64 flex flex-end items-center w-min min-h-32 bg-maroon p-2 text-gold-400 rounded-r-xl border-gold-500 border-[1px] border-l-0 shadow-lg shadow-black/20 -translate-x-[85%] group hover:translate-x-0 focus:translate-x-0 transition-transform duration-1000 cursor-pointer">
