...
<Transition>
	...
	>
		<Card class="w-full  md:w-3/5 p-4 text-[18px] md:text-[20px] lg:text-[24px] leading-relaxed md:p-16">
			<div class="w-full">
		...
		<Card class=" md:w-3/5 p-4 text-[18px] md:text-[20px] lg:text-[24px] leading-relaxed md:p-16">
	...
	<div class="flex flex-col items-start">
		<Card class="md:w-1/2 p-4 text-[18px] md:text-[20px] lg:text-[24px] leading-relaxed md:p-16" light>
	...
	<div class="flex flex-col items-end p-4 md:p-16">
		<Card class=" md:w-1/2 p-4 text-[18px] md:text-[20px] lg:text-[24px] leading-relaxed md:p-16">
