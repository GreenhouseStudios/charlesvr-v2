...
<Background src="..//backgrounds/crowning.jpg" parallax classes="flex flex-col items-end p-4 md:p-16 2xl:p-32 2xl:px-64">
...
<!-- Purple Section -->
<Background src="..//backgrounds/tex16-1.jpg" scrim="none" classes="flex flex-col md:gap-24 auto-rows-max p-4 md:p-16 2xl:p-32 2xl:px-64">
    ...
    <Card classes="mb-24 block" flex="">
        <img src="..//content/rota-porfiletica-st-peter.jpg" class="float-left mr-4 max-w-[33%] rounded" alt="">
    ...
    <Card classes="mb-24 block" flex="">
        <img src="..//content/Maarten_van_Heemskerck_013.jpg" class="float-right ml-4 max-w-[33%] rounded" alt="">
    ...
    <div class="flex flex-col md:grid grid-cols-3 gap-4 md:gap-8">
        ...
        <img src="..//content/Coronation_of_Louis_XV_in_Reims.jpg" alt="" class="rounded-md shadow-lg">
    </div>
    <Citation/>

</Background>
<!-- Red Section -->
<Background parallax src="..//backgrounds/tex16-35.jpg" classes="flex flex-col items-center p-4 md:p-16 2xl:p-32 2xl:px-64">
    <Card classes="mb-24">
    ...
    <div class="md:grid grid-cols-2 gap-4 md:gap-24">
        <img src="..//content/Isotta_Brembati_Grumelli,_by_Giovanni_Battista_Moroni.jpg" alt="" class="rounded-md shadow-lg">
