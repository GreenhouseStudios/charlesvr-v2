...
<Transition>
	...
	>
		<Card class="">
			<div class="w-full p-4 text-[18px] md:text-[20px] lg:text-[24px] leading-relaxed md:p-16">
	...
	<Background src="..//backgrounds/mural.jpg" class="flex flex-col justify-center items-center h-[100vh] p-4 md:p-16 2xl:p-32 2xl:px-64" scrim="maroon" opacity1="7" opacity2="3">
		...
		<Card class=" !text-gold-400 text-2xl md:text-3xl italic p-4 leading-relaxed md:p-16">
