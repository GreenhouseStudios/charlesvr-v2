...
<Transition>
	...
	scrim="light" opacity1="7" opacity2="5"
>
	<Card class=""light >
...
<div class="m-8 italic">
	...
	<Background src="../../backgrounds/basilicaexterior2.jpg"  class="flex flex-col justify-center items-center md:space-y-24 2xl:p-32 2xl:px-64 bg-cover lg:bg-fixed" scrim="light" opacity1="8" opacity2="6">
		<Card class="" light >
			<!-- <Audio></Audio> -->
...
<br>
	...
	>
		...
		<TextCard class="flex flex-col items-center " light>
			...
			<ChapterButton numeral="VI" chapter="The Charles V|R Experience" path="6" class="flex items-center justify-center m-auto" />
		</TextCard>
	</Background>
</Transition>
<Footer></Footer>
