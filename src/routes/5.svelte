...
<Transition>
	...
	>
		<Card class="mb-4 w-full md:mb-24 md:w-1/2">
		...
		<Card class="mb-4 !text-4xl !leading-loose !text-gold-400 md:mb-24">
	...
	<Background
		...
		class="flex flex-col items-center p-4 pb-16 md:p-16 2xl:p-32 2xl:px-64"
	>
		<Card class="my-24 md:my-48">
