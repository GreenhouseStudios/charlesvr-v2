...
<Transition>
    ...
    <SectionHero title="A Coronation Mass" bg="../../static/backgrounds/exterior.jpg" opacity="7"/>
    <Background parallax src="../../static/backgrounds/paintings.jpg" classes="flex flex-col items-end p-4 md:p-16 2xl:p-32 2xl:px-64">
...
<video class="w-screen h-screen -z-50 fixed inset-0 aspect-auto object-cover" loop={true} muted={true} autoplay={true}>
    <source src="../../static/backgrounds/choirshot.mp4" type="video/mp4">
</video>
<Background src="" parallax classes="flex flex-col items-end p-4 md:p-16 2xl:p-32 2xl:px-64">
    <Card classes="my-24 md:my-48" >
...
<Background src="../../static/backgrounds/mural.jpg" classes="flex flex-col p-4 md:p-16 2xl:p-32 2xl:px-64">
...
<SectionHero title="A Melancholic Coronation" bg="../../static/backgrounds/stand.jpg" opacity="7"/>
...
<Background  src="../../static/backgrounds/musicstand.jpg" classes="flex flex-col items-center p-4 md:p-16 2xl:p-32 2xl:px-64">
    <Card classes="my-24 md:my-48">
...
<Background  src="../../static/backgrounds/wall.jpg" parallax classes="flex flex-col items-center p-4 md:p-16 2xl:p-32 2xl:px-64">
    <Card classes="my-24 md:my-48">
