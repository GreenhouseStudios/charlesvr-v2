...
<Transition>
    ...
    <Background parallax src="..//backgrounds/paintings.jpg" classes="flex flex-col items-end p-4 md:p-16 2xl:p-32 2xl:px-64">
...
<Background src="..//backgrounds/mural.jpg" classes="flex flex-col p-4 md:p-16 2xl:p-32 2xl:px-64">
...
<Background  src="..//backgrounds/musicstand.jpg" classes="flex flex-col items-center p-4 md:p-16 2xl:p-32 2xl:px-64">
    <Card classes="my-24 md:my-48">
...
<Background  src="..//backgrounds/wall.jpg" parallax classes="flex flex-col items-center p-4 md:p-16 2xl:p-32 2xl:px-64">
    <Card classes="my-24 md:my-48">
