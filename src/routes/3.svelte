...
<Transition>
    ...
    <Background parallax src="..//backgrounds/fabric.jpg" classes="flex flex-col items-center p-4 md:p-16 2xl:p-32 2xl:px-64">
...
<Background src="..//backgrounds/battle-of-pavia.jpg" scrim="light" classes="flex flex-col p-4 md:p-16 2xl:p-32 2xl:px-64">
    <div class="grid 2xl:grid-cols-[3fr_4fr] gap-24">
        ...
        <BioCard name="King Francis I" src="..//character-cards/Francis I.jpg" years="1494-1547" classes="mb-4 md:mb-24">
...
<Background src="..//backgrounds/sackofrome.jpg" parallax classes="flex flex-col items-center p-4 md:p-16 2xl:p-32 2xl:px-64">
    <Card classes="mb-24">
