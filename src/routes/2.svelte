...
<Background parallax src="..//backgrounds/Bologna_Italy_San_Petronio_from_Asinelli.jpg" classes="flex flex-col space-y-24 p-4 md:p-16 2xl:p-32 2xl:px-64">
    <Card classes="md:w-1/2">
...
<Background src="..//backgrounds/holy-roman-empire.jpg" scrim="light" opacity="9" classes="flex flex-col space-y-24 p-4 md:p-16 2xl:p-32 2xl:px-64">
    <div class="grid 2xl:grid-cols-[1fr_2fr] gap-24">
        <Card classes="" light>
        ...
        <BioCard name="Charlemagne" src="..//character-cards/Charlemagne.jpg" years="742-814" classes="">
    ...
    <div class="grid 2xl:grid-cols-[2fr_1fr] gap-24">
        <Card light classes="">
    ...
    <BioCard name="Otto I" src="..//character-cards/Otto.jpg" years="912-973" classes="2xl:order-first" >
        <p>Called the "Father of Europe" for uniting most of Western Europe</p>
...
<Background src="..//backgrounds/damask_albedo-01.svg" cover={false} classes="flex flex-col md:grid md:grid-cols-2 md:gap-24 auto-rows-max p-4 md:p-16 2xl:p-32 2xl:px-64">
    <div>
        <h2 class="text-4xl md:text-5xl lg:text-6xl text-white text-center underline underline-offset-8 decoration-gold-500 w-full mb-12">
            Dual Coronations
        </h2>
        <Card classes="mb-4 md:mb-12">
